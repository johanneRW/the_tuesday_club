...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='MemberStatus',
            fields=[
                ('member_status_id', models.IntegerField(primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='MemberPassword',
            fields=[
                ('member', models.OneToOneField(db_column='member_id', on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='myapp.member')),
        ...
        migrations.AddField(
            model_name='member',
            name='member_role',
            field=models.OneToOneField(db_column='member_role_id', on_delete=django.db.models.deletion.CASCADE, to='myapp.memberrole'),
        ),
        migrations.AddField(
            model_name='member',
            name='member_status',
            field=models.OneToOneField(db_column='member_status_id', on_delete=django.db.models.deletion.CASCADE, to='myapp.memberstatus'),
        ),
        migrations.CreateModel(
            name='Pile',
            fields=[
                ...
                ('member', models.ForeignKey(db_column='member_id', on_delete=django.db.models.deletion.CASCADE, to='myapp.member')),
